...
void UPlotGraphLibrary::setGraphData(int32 handle, FGraphData graphData)
{
...
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
void UPlotGraphLibrary::getGraphData(int32 handle, FGraphData & graphData)
{
	graphData = gGraphs[handle];
}
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
void UPlotGraphLibrary::createGraph(int32 id, float height, float width, int32 cellsize, float offsetX, float offsetY, float scaleX,
...
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
void UPlotGraphLibrary::isfirstOrSecondFloat(bool isFirst, float first, float second, float &val)
{
	val = isFirst ? first : second;
}
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
void UPlotGraphLibrary::addGraphPoint(int32 handle, FVector2D fv)
{
	FGraphData fg;
	FVector2D fvout;
...
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
bool UPlotGraphLibrary::isPointInRect(FVector2D point, float height, float width, float offsetX, float offsetY)
{
...
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
void UPlotGraphLibrary::clipTranslatedPoints(int32 handle)
{
...
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
void UPlotGraphLibrary::returnGraphTranslatedPoints(int32 handle, TArray<FVector2D> &translatedPoints, FVector2D &markerSize)
{
...
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
void UPlotGraphLibrary::clearGraphPoints(int32 handle)
{
	gGraphs[handle].RawPoints.Empty();
	gGraphs[handle].TranslatedPoints.Empty();
}
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
void UPlotGraphLibrary::createDemoPoints(int32 handle)
{
...
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
bool UPlotGraphLibrary::generateAxisFromID(int32 id, TArray<FVector4> &lines)
{
...
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
bool UPlotGraphLibrary::generateAxis(int32 cellsize, int32 gridNum, float height, TArray<FVector4> &points)
{
	//	const int cellsize = 20;   // 20 pixels wide/high cells. 
	FVector4 fv;
...
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
void UPlotGraphLibrary::generateGraphOffsets(float height, float width, int32 cellsize, float offsetX, float offsetY, float scaleX, float scaleY, FVector4 line, FVector2D &PointA, FVector2D &PointB, FString & label)
{
...
//UNUSED
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
void UPlotGraphLibrary::generateGraphOffsetsFromID2(int32 id, FVector4 line, FVector2D &PointA, FVector2D &PointB, FString & labelX, FString &labelY, bool & isLabelX, FVector2D & labelPosition, bool & isOriginLine)
{
	FGraphData fg;
...
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
bool UPlotGraphLibrary::translateGraphPoint(int32 id, float markerSize, FVector2D PointIn, FVector2D &PointOut)
{
...
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
void UPlotGraphLibrary::switchStringOnBool(bool dofirst, FString first, FString second, FString & stringChosen)
{
	stringChosen = dofirst ? first : second;
}
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
void UPlotGraphLibrary::switchColorOnBool(bool dofirst, FLinearColor first, FLinearColor second, FLinearColor & color)
{
	color = dofirst ? first : second;
}
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
void UPlotGraphLibrary::switchFloatOnBool(bool dofirst, float first, float second, float & val)
{
...
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
void UPlotGraphLibrary::changeGraphParm(int32 handle, EGraphParam eParam, float value, bool addValuetoExisting/*=true*/)
{
...
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
void UPlotGraphLibrary::recalcGraphTranslatedPoints(int32 handle)
{
	FGraphData *p = &gGraphs[handle];
	FVector2D fv;
...
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
void UPlotGraphLibrary::returnPointSetTranslatedPoints(int32 graphHandle, int32 pointSetHandle, TArray<FVector2D> &translatedPoints, FVector2D &markerSize,
...
UFUNCTION(BlueprintCallable, Category = "ROS_GRAPH")
bool UPlotGraphLibrary::generateAxisFromID2(int32 id, TArray<FVector4> &lines)
{
	//	const int cellsize = 20;   // 20 pixels wide/high cells. 
	FVector4 fv;
	FGraphData * pFg;
